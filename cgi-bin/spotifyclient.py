...
class SpotifyClient:
    ...
    def __init__(self, authorization_token, user_id, userplaylist_id):
        """
        :param authorization_token (str): Spotify API token
        :param user_id (str): Spotify user ID
        :param user_name (str): Username para o sistema
        :param userplaylist_id (str): Spotify playlist ID
        """
        self._authorization_token = authorization_token
        self._user_id = user_id
        self.playlist_id = userplaylist_id

    def get_clientplaylist_tracks(self):
    ...
    def get_track_recommendations(self, seed_tracks, limit=45):
    ...
    def create_playlist(self, name):
        ...
        data = json.dumps({
            "name": name,
            'description': 'Faixas para a sua ocasição',
            "public": True
        })
    ...
    def populate_playlist_acess(self, playlist_id, tracks):
        """Add tracks to a playlist.
        :param playlist (Playlist): Playlist to which to add tracks
        :param tracks (list of Track): Tracks to be added to playlist
        :return response: API response
